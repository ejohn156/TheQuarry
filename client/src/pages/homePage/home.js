        ...
        <div class="job-sev-cards">
            ...
            <div class="card-j">
                <div class="card-body-js">
                    ...
                    <Link class="card-js-links" to={sessionStorage.getItem("id") == undefined ? "/login":"/post/Job"}>Post a job ></Link>
                </div>
            </div>
            {/* service card */}
            <div class="card-s">
                <div class="card-body-js">
                    ...
                    <Link class="card-js-links" to={sessionStorage.getItem("id") == undefined ? "/login":"/post/Service"}>Post a service ></Link>
                </div>
            </div>
        </div>
